...
<div class="ibox">
    <div class="ibox-content">
        <p>
            <?= $can['create']?
                Html::a('<i class="fa fa-plus"></i> NUEVA VENTA', ['pre-venta'], ['class' => 'btn btn-success btn-lg add']): '' ?>
        </p>
                    ...
                    <div class="panel-body pad-btm-15px">
                        <div>
                           ...
                           <div class="DateRangePicker   kv-drp-dropdown">
                            ...
                            <?=  Html::dropDownList('sucursal_venta_id', null, Sucursal::getRuta(), ['prompt' => 'Ruta', 'class' => 'max-width-170px'])  ?>
                        </div>
                    </div>
                </div>
            </div>
